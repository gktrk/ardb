...
BrowserCryptModel::SetSortColumn (int iColumn)
{
  ...
  switch (iColumn)
    {
    case 1:
    case -1: m_sSortSuffix << wxT ("hav"); break;
    case 2:
    case -2: m_sSortSuffix << wxT ("wan"); break;
    case 3:
    case -3: m_sSortSuffix << wxT ("spa"); break;
    case 4:
    case -4: m_sSortSuffix << wxT ("dumbitdown(card_name)"); break;
    case 5:
    case -5: m_sSortSuffix << wxT ("advanced"); break;
    case 6:
    case -6: m_sSortSuffix << wxT ("capacity"); break;
    case 7:
    case -7: m_sSortSuffix << wxT ("disciplines"); break;
    case 8:
    case -8: m_sSortSuffix << wxT ("card_type"); break;
    case 9:
    case -9: m_sSortSuffix << wxT ("title"); break;
    case 10:
    case -10: m_sSortSuffix << wxT ("groupnumber"); break;
    case 11:
    case -11: m_sSortSuffix << wxT ("card_text"); break;
    default: m_sSortSuffix << wxT ("dumbitdown(card_name)"); break;
    }
